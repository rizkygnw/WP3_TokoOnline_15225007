                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" title="Ubah Data"><button type="button" class="btn btn-warning btnsm"><i class="fas fa-eye"></i> Detail</button></a>
                                    <a href="#" title="Ubah Data"><button type="button" class="btn btn-cyan btnsm"><i class="far fa-edit"></i> Ubah</button></a>
